...
function Myticket() {
  ...
  async function getdata(id) {
    try {
      let res = await axios.post(`${BASE_URL}/order/myticket`, {
        id,
      });
      // console.log(res);
      setdata(res.data);
  ...
  async function getdataToday() {
    ...
    try {
      let res = await axios.post(`${BASE_URL}/order/myticket/today`, {
  ...
  async function getdataUpcoming() {
    ...
    try {
      let res = await axios.post(
        `${BASE_URL}/order/myticket/upcoming`,
        {
          id,
        }
      );
  ...
  async function getdataPast() {
    let id = Cookies.get("userid");
    try {
      let res = await axios.post(`${BASE_URL}/order/myticket/past`, {
  ...
  async function handledelete(ele) {
    ...
    try {
      let res = await axios.delete(
        `${BASE_URL}/order/oneorder/:${userid}`
      );
      getdata(userid1);
